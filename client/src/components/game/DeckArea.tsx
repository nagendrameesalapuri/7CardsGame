    ...
    <>
      <div className="flex flex-col items-center gap-4 sm:gap-5">
        ...
        <div className="flex items-end gap-4 sm:gap-6">
          ...
          <div className="flex flex-col items-center gap-1.5">
            ...
            <div className="relative">
              ...
              <div className="absolute inset-x-0 -bottom-2 flex justify-center pointer-events-none">
                <span
                  className="text-[7px] sm:text-[8px] font-black px-2 py-0.5 rounded-full leading-none whitespace-nowrap"
                  style={{
          ...
          {/* Divider */}
          <div
            className="self-center h-16 w-px"
            style={{
              background:
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <div className="relative">
              ...
              <div
                className="absolute top-1 left-1 w-10 h-14 sm:w-14 sm:h-20 rounded-xl opacity-30"
                style={{
                  background: "linear-gradient(135deg,#1e3a6e,#1e40af)",
                }}
              />
              <div
                className="absolute top-0.5 left-0.5 w-10 h-14 sm:w-14 sm:h-20 rounded-xl opacity-50"
                style={{
                  background: "linear-gradient(135deg,#1e3a6e,#1e40af)",
                }}
              />
              ...
              {/* Count badge */}
              <div
                className="absolute -top-2.5 -right-2.5 w-6 h-6 rounded-full flex items-center justify-center text-[9px] font-black z-10"
                style={{
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <div className="relative">
              <motion.div
                whileHover={
                  canDrawFromDiscard && topDiscard ? { scale: 1.07, y: -4 } : {}
                }
                whileTap={
                  canDrawFromDiscard && topDiscard ? { scale: 0.94 } : {}
                }
                onClick={() =>
                  canDrawFromDiscard && topDiscard && drawCard("discard")
                }
                className={clsx(
                  canDrawFromDiscard && topDiscard
                    ? "cursor-pointer"
                    : "cursor-default",
                )}
                style={{
              ...
              >
                {topDiscard ? (
                  ...
                  <div
                    className="w-10 h-14 sm:w-14 sm:h-20 rounded-xl flex items-center justify-center text-[9px] font-semibold"
                    style={{
              ...
              {topDiscardIsSpecial && canDraw && (
                ...
                >
                  ...
                  <span className="text-white text-[8px] font-black text-center leading-tight mt-0.5">
                    Deck
                    <br />
                    only
                  </span>
